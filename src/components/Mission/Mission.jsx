        ...
        <section class="flex column mission">
            ...
            <div class="flex mission-container">
                <div class="flex column mission-text left">
                    <h4><strong>Provide 24/7 access<br/></strong> Access to essential medications
            ...
            situation.</h4>
                    <h4><strong>Leverage technology<br/></strong> Harnessing the power of
            ...
            way healthcare services are provided and consumed.</h4>
                ...
                <div class="flex column mission-text right">
                    <h4><strong>Bridge healthcare gaps<br/></strong> We aim to close the
            ...
            unique needs.</h4>
                    <h4><strong>Empower communities<br/></strong> By simplifying access to
